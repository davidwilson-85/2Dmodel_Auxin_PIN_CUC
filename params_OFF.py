...
k_auxin_synth = .8 #0.8 # Basal abs. amount of molecules synthesized per cell per unit of time
k_auxin_degr = .02 #.02 #0.2 #0.02 #0.01 #0.06 # Rel. amount of molecules degraded per unit of time
...
cuc_threshold_pin1 = 3 # For dual PIN1 polarization
...
k_cuc_pin1 = 0 #.1 #.01
k_pin1_effi_basal = .005 #.02 #.01   # = auxin mol. transp. / ( PIN1 molecule * cycle )
k_pin1_effi_cuc = 0 #.01 #.04 #.1 # CUC effect on PIN1 efficiency [0 = no effect]
...
template_proximodistal_axis = np.array([0,0,0,0,0,0,1,3,5,8,9,9,9], dtype=float)
