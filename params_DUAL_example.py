...
create_video = True
create_gif = False
simulation_description = 'Dual model used in the paper'
...
k_auxin_synth = 1 #1 # Basal abs. amount of molecules synthesized per cell per unit of time
...
# PIN1 localization
pin1_polarity = 'dual'   # 'dual' OR 'utg_smith2006' OR 'wtf_abley2016'
...
k_auxin_pin1 = .0001 #.005 #.003 #.0001
k_cuc_pin1 = .02 #.1 #.01
k_md_pin1 = 0
k_pin1_effi_basal = .009 #.02 #.01   # = auxin mol. transp. / ( PIN1 molecule * cycle )
k_pin1_effi_pho = 'n/a'   # Transport efficiency of PIN1-P molecules
pin1_pho_k05 = 5 #.04 #.1 # [CUC] where effect half PIN1 molecules are phosphorylated. Use very high value to turn off
pin1_pho_hc = 2 # Hill coefficient. Determines the steepness and shape of the Hill function
...
template_proximodistal_axis = np.array([0,0,0,0,0,0,0,0,1,3,5,8,9,9,9], dtype=float)
